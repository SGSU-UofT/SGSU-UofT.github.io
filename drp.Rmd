...
<details class="type1">
<summary>
What is the proper way to describe the experience in your CV?
</summary>
Being transparent and accurate when applying to jobs/academic positions is very important for a good reputation. This program may be a legitimate research experience, but it is quite modern and not all prospective employers might know about it. As such, it should be described explicitly as a *Directed Reading Program* with a *graduate student mentor*, from the Department of Statistical Sciences at UofT. You are also welcome to include a link to this site for maximum precision.
</details>

[**Applications for the Winter 2026 session are now closed. We sincerely thank all of those who applied!**]
...
<details class="type2"><summary>Concentration Inequalities: A Nonasymptotic Theory of Independence</summary>
...
<details class="type2"><summary>Quantifying uncertainty with Conformal Prediction</summary>
...
<div class="content"><p>This project will be focused on classic dimensionality reduction techniques such as PCA, CCA, ICA and their variants.</p><p class="highlight">Mentor: [Arian Hashemzadeh](https://arian-hashemzadeh.github.io/). Suggested prerequisites: STA220 and STA257 (or similar) and knowledge of linear algebra.</p></div></details>

<details class="type2"><summary>Topics in Causal Discovery</summary>
<div class="content"><p>This project will involve an overview of the constraint-based and score-based causal discovery methods and their challenges.</p><p class="highlight">Mentor: [Arian Hashemzadeh](https://arian-hashemzadeh.github.io/). Suggested prerequisites: STA257 or similar, knowledge of linear algebra and introductory knowledge of graph theory.</p></div></details>
